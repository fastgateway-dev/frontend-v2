...
import { hasCertPerm, certStatusBadge } from '@/lib/utils/certificates';
import type { ManagedCertificate, Project, ProjectPermissions, CertificateIssuer } from '@/types';
...
export default function CertificatesPage() {
  ...
  const loadData = async () => {
    ...
    setError(null);
    try {
      const [projectData, certificatesData, permsData, issuersData] = await Promise.all([
                    ...
                    <div className="flex items-center justify-between">
                      <div className="flex items-center gap-4">
                        ...
                        <div>
                          ...
                          <p className="text-sm text-gray-500">Issuer: {issuerNamesById[cert.issuerId] || cert.issuerId}</p>
                        </div>
                      </div>
